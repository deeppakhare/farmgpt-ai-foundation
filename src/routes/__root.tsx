...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "FarmGPT AI is the intelligent AI workspace for farmers — diagnose crop disease, monitor weather, and get smarter farming advice in one premium app." },
